...
We consider the scenario of event listings aggregation. Typically, event aggregators information about different types of events over different locations. Typically, event aggregators is interested in collecting diverse events spanning from movie shows and concerts to political rallies for multiple locations across different countries. The goal of EventAggr is to 
